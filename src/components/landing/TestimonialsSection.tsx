...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "Раньше мы сами пытались участвовать в тендерах и постоянно проигрывали из-за ошибок в документах. С ТендерПро выиграли первый же контракт на 4,2 млн рублей.",
      name: "Алексей Воронов",
      company: "Генеральный директор, СтройМонтаж",
      image: "/testimonial-avatar-1.jpg",
    },
    {
      quote:
        "Отдали тендерное сопровождение на аутсорс и не пожалели. Команда берёт на себя всё — мы только согласовываем стратегию и получаем результат.",
      name: "Екатерина Смирнова",
      company: "Коммерческий директор, МедТехПоставка",
      image: "/testimonial-avatar-2.jpg",
    },
    {
      quote:
        "За полгода работы выиграли 7 государственных контрактов на общую сумму свыше 18 млн рублей. Рекомендуем всем, кто работает в сфере госзакупок.",
      name: "Дмитрий Козлов",
      company: "Владелец, ПромСнаб Групп",
